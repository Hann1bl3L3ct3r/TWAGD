...
def monitor_and_kill_process(process_name, device_name, ioctl_code):
    print("[!] Monitoring process for termination. Press Enter to stop.")
    while True:
...
if __name__ == "__main__":
    ...
    monitoring_thread = threading.Thread(target=monitor_and_kill_process, args=(process_name, device_name, ioctl_code), daemon=True)
